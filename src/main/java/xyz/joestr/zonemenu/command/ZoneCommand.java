...
public class ZoneCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender commandSender, Command command, String label, final String[] args) {
		...
		if (!(commandSender instanceof Player)) {
			...
			commandSender.sendMessage(this.plugin.colorCode('&', (String) this.plugin.configDelegate.getMap().get("head")));
			commandSender.sendMessage(
					this.plugin.colorCode('&', (String) this.plugin.configDelegate.getMap().get("not_a_player_message")));
							...
							(String) this.plugin.configDelegate.getMap().get("head")
									+ (String) this.plugin.configDelegate.getMap().get("head_extra")))
											...
											.event(new ClickEvent(ClickEvent.Action.RUN_COMMAND,
													"/zone cancel"))
											.append("\n" + this.plugin.colorCode('&',
													(String) this.plugin.configDelegate.getMap().get("list")))
											.event(new HoverEvent(HoverEvent.Action.SHOW_TEXT,
													new ComponentBuilder(this.plugin.colorCode('&',
															(String) this.plugin.configDelegate.getMap()
																	.get("list_hover"))).create()))
											.event(new ClickEvent(ClickEvent.Action.RUN_COMMAND,
													"/zone list"))
											.append("\n" + this.plugin.colorCode('&',
